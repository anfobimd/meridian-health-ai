...
export function QuickDock({
  ...
  return (
    <>
      ...
      {/* Pricing Quote Sheet */}
      <Sheet open={active === "quote"} onOpenChange={(o) => !o && handleClose()}>
      ...
      {/* Send Intake Link — Patient Picker step */}
      {active === "sendlink" && !selectedPatient && (
      ...
      {/* Send Intake Link — Dialog after patient selected */}
      {active === "sendlink" && selectedPatient && (
